...
export const MapPage = () => {
  ...
  const polygon = new kakao.maps.Polygon({
    ...
    /* 2. */
    axios.get(`http://1027-alb-1456013350.ap-northeast-2.elb.amazonaws.com/api/area/`)
    .then((res) => {
      console.log(res.data);
      setcareas(res.data.data);
        ...
        <div className="inner">
          <div className="category-container">
            <div className="category-list">
              <button className="category-item" id="U">관광특구</button>
              <button className="category-item" id="A">골목상권</button>
              <button className="category-item" id="D">발달상권</button>
              <button className="category-item" id="R">전통시장</button>
